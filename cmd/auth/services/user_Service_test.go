...
func (m *mockTokenService) Sign(claims *pkg.Claims, duration time.Duration) (string, error) {
	args := m.Called(claims, duration)
	return args.String(0), args.Error(1)
}

func (m *mockTokenService) Validate(tokenString string) (*pkg.Claims, error) {
